...
| `rkit:pages` | List, read, create, update, move, and delete team Pages (the wiki/docs tree); show, filter by, add, or remove page labels; lock, unlock, or check whether a page is locked. |
